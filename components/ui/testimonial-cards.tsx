      ...
      <div className="relative mb-12 h-[350px] md:h-[400px] w-full">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="absolute inset-0 rounded-2xl border border-white/[0.08] bg-gradient-to-br from-white/[0.05] to-white/[0.02] backdrop-blur-sm p-8 md:p-12 flex flex-col justify-between overflow-hidden"
          >
            {/* Accent glow */}
            <div className="absolute -inset-px rounded-2xl bg-gradient-to-br from-purple-500/20 via-transparent to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity blur-sm pointer-events-none" />

            {/* Quote icon */}
            <div className="mb-6">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500/20 to-blue-500/20 border border-white/[0.08]">
                <IconQuote className="w-6 h-6 text-purple-400" />
              </div>
            </div>

            {/* Quote text with word-by-word reveal */}
            <motion.blockquote className="text-lg md:text-2xl font-light leading-relaxed text-neutral-200 mb-8">
            ...
            <div className="min-w-0">
              <p
                className={`text-sm font-medium truncate ${
                  index === active ? "text-white" : "text-neutral-400"
                }`}
              >
                {testimonial.name}
              </p>
