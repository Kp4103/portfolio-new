...
import { useOutsideClick } from "@/hooks/use-outside-click";  // Assuming this is a custom hook for detecting clicks outside an element

// Type Definitions for Carousel and Card Props
type Card = {
  src: string;
  title: string;
  category: string;
...
// Carousel Context for managing the current index and card close event
...
// BlurImage Component (for lazy-loaded background images)
